...
export class AboutComponent implements OnInit, AfterViewInit {
 tabs = [
    { id: 'dean-message',      label: 'كلمة العميد',                    icon: 'pi pi-star' },
    { id: 'vision-mission',    label: 'الرؤية والرسالة',              icon: 'pi pi-lightbulb' },
    { id: 'objectives',        label: 'الأهداف',                       icon: 'pi pi-users' },
    { id: 'admin-structure',   label: 'الهيكل الإداري',                icon: 'pi pi-users' }
  ];
